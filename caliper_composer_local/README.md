...
## HOW TO USE
nvm version 8.9.4 
composer-cli 0.19.8 and fabric version 1.1.0
node scripts/main.js -c benchmark/composer/config-composer-smarthomes.yaml -n network/fabric-v1.1/2org1peercouchdb/composer.json