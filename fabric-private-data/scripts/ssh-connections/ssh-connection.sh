...
tmux new-session -s "CA" \; \
	...
	send-keys 'cd fabric-private-data/scripts/orderer' C-m \; \
	send-keys './stop.sh' C-m \; \
	send-keys './start-orderer.sh' C-m \; \
	split-window -v -p 75 \; \
	send-keys 'ssh  peer0' C-m \; \
	send-keys 'cd fabric-private-data/scripts/peer0' C-m \; \
	send-keys './stop.sh' C-m \; \
	send-keys './start-peer0.sh' C-m \; \
	split-window -h -p 50 \; \
	send-keys 'ssh peer1' C-m \; \
	send-keys 'cd fabric-private-data/scripts/peer1' C-m \; \
	send-keys './stop.sh' C-m \; \
	send-keys './start-peer1.sh' C-m \; \
	split-window -v -p 50 \; \
	send-keys 'ssh peer3' C-m \; \
	send-keys 'cd fabric-private-data/scripts/peer3' C-m \; \
	send-keys './stop.sh' C-m \; \
	send-keys './start-peer3.sh' C-m \; \
	select-pane -t 1 \; \
	split-window -v -p 50 \; \
	send-keys 'ssh peer2' C-m \; \
	send-keys 'cd fabric-private-data/scripts/peer2' C-m \; \
	send-keys './stop.sh' C-m \; \
	send-keys './start-peer2.sh' C-m \; \
	select-pane -t 0 \; \
	split-window -h -p 50 \; \
	send-keys 'ssh peer4' C-m \; \
	send-keys 'cd fabric-private-data/scripts/peer4' C-m \; \
	send-keys './stop.sh' C-m \; \
